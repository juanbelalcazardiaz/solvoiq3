...
const dashboardTasksForClients: Task[] = INITIAL_CLIENTS.map(client => ({
  ...
  assignedTo: JUAN_BELCAZAR_PROFILE.id,
  clientId: client.id,
...
export const INITIAL_TASKS: Task[] = [
  ...
  { id: 'task_c1868_f1', title: 'Email KPI proposal to Julie.', description: 'Send the drafted KPI proposal to Julie Halls.', status: TaskStatus.COMPLETED, dueDate: new Date('2025-06-05T00:00:00Z').toISOString(), assignedTo: JUAN_BELCAZAR_PROFILE.id, clientId: 'c1868', priority: TaskPriority.MEDIUM, elapsedTimeSeconds: 0 },
  ...
  { id: 'task_c1495_f2', title: 'Plan the next meeting agenda for July WBR.', description: 'Prepare agenda for the next monthly meeting with Michael Botelho.', status: TaskStatus.COMPLETED, dueDate: new Date('2025-06-28T00:00:00Z').toISOString(), assignedTo: JUAN_BELCAZAR_PROFILE.id, clientId: 'c1495', priority: TaskPriority.LOW, elapsedTimeSeconds: 0 },

  { id: 'task_c1168_1', title: 'Prepare marketing plan presentation.', description: 'Include domain and SEO strategy for meeting with Jamile Gallegos.', status: TaskStatus.COMPLETED, dueDate: new Date('2025-06-12T00:00:00Z').toISOString(), assignedTo: JUAN_BELCAZAR_PROFILE.id, clientId: 'c1168', priority: TaskPriority.HIGH, elapsedTimeSeconds: 0 },
  { id: 'task_c1168_2', title: 'Discuss Mariana’s vacation (July 7–11).', description: 'Address Mariana Marcela Arevalo Gutierrez\'s vacation plans during the meeting.', status: TaskStatus.COMPLETED, dueDate: new Date('2025-06-13T00:00:00Z').toISOString(), assignedTo: JUAN_BELCAZAR_PROFILE.id, clientId: 'c1168', priority: TaskPriority.MEDIUM, elapsedTimeSeconds: 0 },
  { id: 'task_c1168_3', title: 'Set KPIs with Jamile.', description: 'Define and agree on Key Performance Indicators with Jamile Gallegos.', status: TaskStatus.COMPLETED, dueDate: new Date('2025-06-13T00:00:00Z').toISOString(), assignedTo: JUAN_BELCAZAR_PROFILE.id, clientId: 'c1168', priority: TaskPriority.HIGH, elapsedTimeSeconds: 0 },
  { id: 'task_c1168_f1', title: 'Send meeting agenda to Jamile.', description: 'Email agenda for June 13 meeting to Jamile Gallegos.', status: TaskStatus.COMPLETED, dueDate: new Date('2025-06-10T00:00:00Z').toISOString(), assignedTo: JUAN_BELCAZAR_PROFILE.id, clientId: 'c1168', priority: TaskPriority.MEDIUM, elapsedTimeSeconds: 0 }, 
  { id: 'task_c1168_f2', title: 'Confirm Mariana\'s vacation approval.', description: 'Follow up and document approval for Mariana\'s vacation post-meeting.', status: TaskStatus.COMPLETED, dueDate: new Date('2025-06-14T00:00:00Z').toISOString(), assignedTo: JUAN_BELCAZAR_PROFILE.id, clientId: 'c1168', priority: TaskPriority.LOW, elapsedTimeSeconds: 0 },
...
export const INITIAL_KPIS: Kpi[] = [
  ...
  { id: 'kpi_c468_solae075_4', name: 'Cancelled Visits', target: parseTarget("20%"), actual: 0, category: 'Scheduler - Weama LLC (Needs Reassignment)', description: "Previously for Angelica Santana. Role reassigned. Target: MINIMIZE.", clientNeedAlignment: "Service reliability", roiDemonstration: "Reduced client inconvenience", historicalData: [], lowerIsBetter: true },
...
export const INITIAL_ONE_ON_ONE_SESSIONS: OneOnOneSession[] = [
  ...
  },
  {
    ...
    generalNotes: "Critical discussion with Juanita regarding Endredy Enterprises (c1035). Client is extremely dissatisfied with her leave frequency and communication. Reviewed specific instances and impact on the client relationship. Juanita acknowledged the severity and impact on the client relationship. Her recruitment performance metrics are strong, but this behavioural issue is overshadowing it. HO is definitely on hold and client wants her on-site only for now.",
    riskAssessment: {
